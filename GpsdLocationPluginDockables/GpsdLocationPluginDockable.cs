...
namespace BillNash.NINA.GpsdLocationPlugin.GpsdLocationPluginDockables {
    /// <summary>
    ...
    public class GpsdLocationPluginDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public GpsdLocationPluginDockable(
            ...
            dict.Source = new Uri("BillNash.NINA.GpsdLocationPlugin;component/GpsdLocationPluginDockables/GpsdLocationPluginDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["BillNash.NINA.GpsdLocationPlugin_AltitudeSVG"];
