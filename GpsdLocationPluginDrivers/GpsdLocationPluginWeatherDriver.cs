...
namespace BillNash.NINA.GpsdLocationPlugin.GpsdLocationPluginDrivers {
    ...
    /// </summary>
    public class GpsdLocationPluginWeatherDriver : BaseINPC, IWeatherData {
        public GpsdLocationPluginWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"GpsdLocationPlugin Weather Data ({deviceId})";
        ...
        public string Category => "GpsdLocationPlugin Weather Driver";
