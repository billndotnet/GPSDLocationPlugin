...
namespace BillNash.NINA.GpsdLocationPlugin.GpsdLocationPluginTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "GPSD Location Plugin")]
    [Export(typeof(ISequenceCondition))]
    [JsonObject(MemberSerialization.OptIn)]
    public class GpsdLocationPluginCondition : SequenceCondition {
        /// <summary>
        ...
        public GpsdLocationPluginCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new GpsdLocationPluginCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(GpsdLocationPluginCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}