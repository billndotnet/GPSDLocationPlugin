...
namespace BillNash.NINA.GpsdLocationPlugin.GpsdLocationPluginTestCategory {
    ...
    public class GpsdLocationPluginTrigger : SequenceTrigger {
        /// <summary>
        ...
        public GpsdLocationPluginTrigger() {
        }

        public override object Clone() {
            return new GpsdLocationPluginTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(GpsdLocationPluginTrigger)}";
        }
    }
}